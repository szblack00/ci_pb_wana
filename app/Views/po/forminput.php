...
<?= $this->section('judul'); ?>
<h5>Input Purchasing Order</h5>
<?= $this->endsection('judul'); ?>

<?= $this->section('subjudul'); ?>

<button type="button" class="btn btn-warning" onclick="location.href=('/po/index')">
    <i class="fa fa-backward"></i> Kembali
</button>

<button type="button" class="btn btn-info" onclick="location.href=('/barang/tambah')">
    <i class="fa fa-file"></i> Data Barang
</button>
