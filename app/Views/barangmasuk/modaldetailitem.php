                ...
                <table class="table table-sm table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $row['brgnama'] ?></td>
                            <td style="text-align: left;"> <?= number_format($row['dethargamasuk'], 0, ",", ".") ?>
                            <td style="text-align: left;"><?= number_format($row['detjml'], 0, ",", ".") ?>
                            <td style="text-align: left;"> <?= number_format($row['detsubtotal'], 0, ",", ".") ?>
                            </td>
                            <?php endforeach; ?>
                        </tr>
                    </tbody>
